        ...
        <div class="main">
            <section class="signup">
                <div class="container">
                    ...
                    {
                        ?>
                        <h1 style="text-align:center">Welcome to Shopper.com</h1>
                        <div
                            ...
                            <a href="." class="loginhere-link"
                                style="float:right;background:tomato;padding:5px;color:white;border-radius:5px;text-decoration:none;margin-top:-10px;margin-right:-20px;">Home</a>
                        </div>
                        <?php
                    } else{
